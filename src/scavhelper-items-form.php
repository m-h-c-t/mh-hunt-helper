...
<form novalidate name="item_list_form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
    <div class="form-group row">
        ...
        <textarea rows="10" class="form-control input-lg" placeholder="Copy map items list here..." required name="items" id="items"><?php if ($results['original_items']) { echo implode("\n", $results['original_items']); } ?></textarea>
    </div>
    <div class="form-group row">
