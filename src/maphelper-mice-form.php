...
<form novalidate name="mice_list_form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
    <div class="form-group row">
        ...
        <textarea rows="10" class="form-control input-lg" placeholder="Copy map mice list here..." required name="mice" id="mice"><?php if (isset($results['original_items']) && !empty($results['original_items'])) { echo implode("\n", $results['original_items']); } ?></textarea>
    </div>
    <div class="form-group row">
