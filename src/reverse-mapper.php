<?php
    $title = "MHCT Reverse Mapper";
    // $css = "styles/loot.css";
    $js = "scripts/reverse-mapper.js";
...
?>
        ...
        <div class="input-group col-sm-6 col-sm-offset-3">
            ...
            <input name="item" id="item" class="form-control input-lg" type="text" placeholder="Start typing mouse name and select." autofocus>
