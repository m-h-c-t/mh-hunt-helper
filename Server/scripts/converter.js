$( function() {
    ...
    function renderResultsTable(data) {
        var final_html = '<table id="results_table" class="table table-striped table-hover"><thead><tr><th>Item</th><th>Seen Convertibles</th><th>Average items</th></tr></thead><tbody>';
